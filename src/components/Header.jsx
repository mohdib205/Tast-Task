...
function Header() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 w-full h-28 z-10 bg-white shadow-lg rounded-b-lg py-2 px-4 border-b border-gray-300">
        ...
        <div className="flex items-center space-x-4 mb-2">
          <div className="flex items-center flex-grow bg-gray-200 p-2 rounded-full shadow-md">
            <FaSearch className="text-gray-500 mr-2 w-5 h-5" />
            <input
              type="text"
              placeholder="Search..."
              className="flex-grow bg-transparent outline-none text-gray-800 placeholder-gray-500 h-4"
              
            />
          </div>
          <div className="flex items-center justify-center w-10 h-10 bg-gray-300 rounded-full shadow-md hover:bg-gray-400 transition duration-300">
            <FaFilter className="text-gray-700 w-4 h-4" />
          </div>
        </div>
      </div>
      {isMenuOpen && (
      ...
      {isProfileOpen && (
        ...
        <div
          className={`fixed right-0 h-full z-40 w-4/5 gap-4 bg-white shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-right-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-right-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg ${isProfileOpen ? "translate-x-0" : "translate-x-full"}`}  
        >
          <div className="p-6 text-black">
            ...
            <ul className="space-y-4 text-black">
              {[
                ...
                {
                  icon: <FaPowerOff className="text-gray-800" />,
                  text: "Appear offline",
                },
                {
                ...
                <li
                  ...
                  className={`flex items-center justify-between p-2 rounded-lg ${
                    item.active ? "bg-gray-300" : "hover:bg-gray-700"
    ...
    <div
      className={`fixed right-0 h-full z-50 w-4/5 gap-4 bg-white shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-right-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-right-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg ${isInsideProfileOpen ? "translate-x-0" : "translate-x-full"}`}  
    >
          <div className=" text-black p-4 w-full">
            ...
            <div className="flex justify-center mb-6">
              <button className="flex items-center space-x-2 bg-gray-100 hover:bg-gray-700 px-4 py-2 rounded-lg shadow-md transition ease-in-out duration-200">
                <FaCamera className="text-black" />
                <span className="text-black font-medium">Update photo</span>
              </button>
            </div>
            ...
            <div className="bg-gray-100 p-4 rounded-lg mb-6 shadow-md">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-sm text-gray-800">Free all day</span>
              </div>
              <p className="text-sm text-gray-900">
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                <div className="flex shrink-0 items-center space-x-3">
                  <FaEnvelope className="text-gray-900 w-4 h-4" />
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 bg-gray-100 p-4 rounded-lg shadow-md">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">DGM - Engineering</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <div className="fixed inset-0 z-50">
    <div
      className={`fixed right-0 flex flex-col h-full z-50 w-4/5 bg-white shadow-lg transition-transform duration-200 ${
    ...
    >
      ...
      <div className="p-2 flex items-center space-x-4 border-t border-gray-900">
        <img
          src="path_to_user_image.jpg"
          alt="User Avatar"
          className="flex-shrink-0 w-12 h-12 rounded-full border-2 border-gray-700 shadow-lg"
        />
        <div className="text-black">
          <h2 className="text-md font-bold">Sai Pavan Saketh Desamsetti</h2>
          <p className="text-sm text-gray-900">Employee Experience API & Integration Engineer</p>
          <p className="text-sm text-gray-900">Digital Innovation & Technology</p>
        </div>
      </div>
      <div className="my-4 px-4 w-full">
        <span className="text-md text-black">Your work</span>
